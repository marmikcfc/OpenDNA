...
fs.createReadStream(process.cwd()+'/uploads/'+filename).pipe(dna.createParser()).pipe(JSONStream.stringify()).pipe(fs.createWriteStream(process.cwd()+'/uploads/'+filename+".json"));
